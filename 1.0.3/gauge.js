(function() { 
		...
		<div class="container">
		  <div class="row">
		    <div class="col-md-4 col-sm-4">
			  ...
			  <rect x="49%" y="13" width="10" height="75"/>
  	                </svg>
		      </div>
		    </div>
		  </div>
	...
	class Box extends HTMLElement {
		...
		render(val, info, color) {
			...
			if (rounded >=0 && rounded <=100) {
				...
				this.$svg.innerHTML = '<path d="M 950 500 A 450 450 0 0 0 50 500"></path><text class="percentage" text-anchor="middle" alignment-baseline="middle" x="500" y="300" font-size="140" font-weight="bold">' + rounded + '%</text><text class="title" text-anchor="middle" alignment-baseline="middle" x="500" y="450" font-size="90" font-weight="normal">' + info + '</text><path d="' + x + '" class="data-arc"></path><rect x="49%" y="13" width="10" height="75"/>"';
			}
		}
	...
	customElements.define("com-orbis-gauge", Box);
})();